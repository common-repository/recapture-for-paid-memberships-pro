...
/*
 * Plugin Name: Recapture for Paid Memberships Pro
...
if (!class_exists('Recapture')) {
    ...
    include(dirname(__FILE__) . '/platforms/class-paid-memberships-pro.php');

    define('RECAPTURE_VERSION', '1.0.12');
    define('RECAPTURE_TEXT_DOMAIN', 'recapture');
    define('RECAPTURE_TARGET_PLATFORM', 'Paid Memberships Pro');
    ...
    class Recapture
    {
        ...
        public function __construct()
        {
            ...
            // setup the platform
            if (RecapturePaidMembershipsPro::is_ready()) {
                $this->platform = new RecapturePaidMembershipsPro();
            } else {
            ...
            // standard wordpress actions used by Recapture
        ...
        public function start_members_export() {
            ...
            wp_schedule_single_event(time(), 'recapture_run_export', [], true);
            ...
            <div class="wrap">
                ...
                <form method="post" action="<?php echo esc_html(admin_url('admin-post.php')); ?>" target="_blank">
                    <?php if (RecaptureUtils::is_connected()) { ?>
                        ...
                        <p>
                            <a href="<?php esc_html_e(wp_nonce_url(admin_url('admin-post.php?action=recapture_export_members'), 'export_recapture_memberships')) ?>" class="button">
    ...
    function recapture_plugin_activated($plugin) {
        $is_ready = RecapturePaidMembershipsPro::is_ready();
